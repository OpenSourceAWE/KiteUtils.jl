...
function Base.show(io::IO, st::SysState)
    ...
    println(io, "aero_force_KA_x [N]:", st.aero_force_KA_x)
    println(io, "aero_force_KA_y [N]:", st.aero_force_KA_y)
    println(io, "aero_force_KA_z [N]:", st.aero_force_KA_z)
    println(io, "aero_moment_KA_x [Nm]:", st.aero_moment_KA_x)
    println(io, "aero_moment_KA_y [Nm]:", st.aero_moment_KA_y)
    println(io, "aero_moment_KA_z [Nm]:", st.aero_moment_KA_z)
    ...
    println(io, "set_ext_force_x [N]:", st.set_ext_force_x)
    println(io, "set_ext_force_y [N]:", st.set_ext_force_y)
    println(io, "set_ext_force_z [N]:", st.set_ext_force_z)
