...
function demo_syslog(P, O=1; duration=10)
    ...
    FX_vec = Vector{MVector{P, MyFloat}}(undef, steps)
    FY_vec = Vector{MVector{P, MyFloat}}(undef, steps)
    FZ_vec = Vector{MVector{P, MyFloat}}(undef, steps)
    ...
    StructArray{SysState{P, O}}((time_vec, t_sim_vec, sys_state_vec, cycle_vec, fig_8_vec, e_mech_vec, 
                              ...
                              acc_vec, X_vec, Y_vec, Z_vec, FX_vec, FY_vec, 
                              FZ_vec, set_torque_vec, set_speed_vec, set_force_vec, roll_vec, pitch_vec, 
