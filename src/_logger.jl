...
@with_kw mutable struct Logger{P, O, D, L, W, T, S, N, F, Q}
    ...
    aero_force_b_x_vec::Vector{MVector{O, F}} = [zero(MVector{O, F}) for _ in 1:Q]
    aero_force_b_y_vec::Vector{MVector{O, F}} = [zero(MVector{O, F}) for _ in 1:Q]
    aero_force_b_z_vec::Vector{MVector{O, F}} = [zero(MVector{O, F}) for _ in 1:Q]
    ...
    gamma_distribution_vec::Vector{MVector{N, F}} = [zero(MVector{N, F}) for _ in 1:Q]
    ...
    set_ext_force_enu_x_vec::Vector{MVector{P, F}} = [zero(MVector{P, F}) for _ in 1:Q]
    set_ext_force_enu_y_vec::Vector{MVector{P, F}} = [zero(MVector{P, F}) for _ in 1:Q]
    set_ext_force_enu_z_vec::Vector{MVector{P, F}} = [zero(MVector{P, F}) for _ in 1:Q]
