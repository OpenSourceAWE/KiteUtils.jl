...
function save_log(logger::Logger, name="sim_log", compress=true;
    ...
    resize!(logger.aero_force_KA_x_vec, nl)
    resize!(logger.aero_force_KA_y_vec, nl)
    resize!(logger.aero_force_KA_z_vec, nl)
    resize!(logger.aero_moment_KA_x_vec, nl)
    resize!(logger.aero_moment_KA_y_vec, nl)
    resize!(logger.aero_moment_KA_z_vec, nl)
    ...
    resize!(logger.set_ext_force_x_vec, nl)
    resize!(logger.set_ext_force_y_vec, nl)
    resize!(logger.set_ext_force_z_vec, nl)
